...
<body class="bg-body-secondary">
  ...
  <div class="sidebar ">
    <ul class="nav d-flex content-center flex-column">
      ...
      <li class="nav-item mb-1">
        <div class="custom-hover">
          <a class="nav-link d-flex align-items-center" href="../Book_Management/book_management.php">
      ...
      <li class="nav-item mb-1">
        <div class="custom-hover">
          <a class="nav-link d-flex align-items-center" href="reader_management.html">
  ...
  <script>
  const ctx = document.getElementById('chart2').getContext('2d'); // Lấy context 2D
